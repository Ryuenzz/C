...
local tab2 = Win:CraftTab('Credit')
local page1 = tab1:CraftPage('Main',1)
local page2 = tab1:CraftPage('Function Toggle',2)
local page3 = tab1:CraftPage('Function Notifcation',2)
local page4 = tab2:CraftPage('Credit',1)
...
page1:MultiDropdown("MultiDropdown",{'Item1',"Item2",'Item3'},{'Item1'},function(a)
    print(a)
end
)
...
page3:Button("Notifcation",function()
    Ui:Notifcation('Notifcation',"Description",5)
end
)
page4:Label('Ui Design By : Synap1_x#5991')
page4:Label('Ui Made By : Synap1_x#5991')
page4:Label('Ui Made By : Native#4345')
